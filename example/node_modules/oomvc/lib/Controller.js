...
var Controller = (function () {
     ...
     * @return {Function}
     */
    Controller.delete = function (path) {
        return function (target, propertyKey, descriptor) {
            descriptor.value.url = path;
     ...
     * @return {Function}
     */
    Controller.prototype.render = function (templateName, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            fs.readFile(_this.viewPath + templateName + ".hbs", 'utf8', function (error, innerText) {
                if (error) {
                    reject(error.message);
                }
                else {
                    var template = Handlebars.compile(innerText);
